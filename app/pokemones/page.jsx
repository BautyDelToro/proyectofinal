...
export default function Pokemones (){
    ...
    return(
        <div className='divpokemones'>
            ...
            <div>
                <Imagentipo titulo="Fuego" imagen="/imagenes/Fuego.png" idd="fire" Poke2="braixen" Poke3="litten" />
                ...
                <Imagentipo titulo="Eléctrico" imagen="/imagenes/Electrico.png" idd="electric" Poke2="raichu-alola" Poke3="luxray" />
                ...
                <Imagentipo titulo="Planta" imagen="/imagenes/Planta.png" idd="grass" Poke2="servine" Poke3="lurantis" />
                ...
                <Imagentipo titulo="Agua" imagen="/imagenes/Agua.png" idd="water" Poke2="greninja" Poke3="gyarados" />
                <Imagentipo titulo="Vuelo" imagen="/imagenes/Vuelo.png" idd="flying" Poke2="golbat" Poke3="staraptor" />
                <Imagentipo titulo="Dragón" imagen="/imagenes/Dragon.png" idd="dragon" Poke2="drakloak" Poke3="salamence-mega" />
                <Imagentipo titulo="Veneno" imagen="/imagenes/Veneno.png" idd="poison" Poke2="haunter" Poke3="arbok" />
                <Imagentipo titulo="Hada" imagen="/imagenes/Hada.png" idd="fairy" Poke2="altaria-mega" Poke3="rapidash-galar" />
